...
# ---------------------------------------
# class viewFavorite(viewsets.ModelViewSet):
#     search_fields = ['userId']
#     filter_backends = (filters.SearchFilter,filters.OrderingFilter)
#     queryset = Favorite.objects.all()
#     serializer_class = FavoriteSerializer
#     # @api_view(["DELETE"])
#     # def product_delete_rest_endpoint(request, favorite_id):
...
#         try:
#             instance = Favorite.objects.get(value=value)
#             instance.delete()
